...
#define	LCD_CS_SET  GPIOC->BSRR=0x200 //1<<9    //片选端口  		PC9
#define	LCD_RS_SET	GPIOC->BSRR=0x100 //1<<8    //数据/命令 		PC8	   
#define	LCD_WR_SET	GPIOC->BSRR=0x080 //1<<7    //写数据			PC7
#define	LCD_RD_SET	GPIOC->BSRR=0x040 //1<<6    //读数据			PC6
								    
#define	LCD_CS_CLR  GPIOC->BRR=0x200 //1<<9     //片选端口  		PC9
#define	LCD_RS_CLR	GPIOC->BRR=0x100 //1<<8     //数据/命令		PC8	   
#define	LCD_WR_CLR	GPIOC->BRR=0x080 //1<<7     //写数据			PC7
#define	LCD_RD_CLR	GPIOC->BRR=0x040 //1<<6     //读数据			PC6   	
